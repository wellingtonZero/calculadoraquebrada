...
class MulNormal extends StatefulWidget {
  @override
  State<MulNormal> createState() => _MulNormalState();
}

class _MulNormalState extends State<MulNormal> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text('MULTIPLICAÇÃO - NORMAL'),
        centerTitle: true,
      ),
      body: SafeArea(
        child: Column(
                        ...
                        child: Container(
                          ...
                          child: Stack(
                            children: [
                              Align(
                                child: RiveAnimation.asset(
                                  'assets/quadroDezesseis.riv',
                                  animations: ['dezesseis'],
                                  fit: BoxFit.cover,
                                ),
                              ),
                            ],

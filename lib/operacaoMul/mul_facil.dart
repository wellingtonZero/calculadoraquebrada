...
class MulFacil extends StatefulWidget {
  @override
  State<MulFacil> createState() => _MulFacilState();
}

class _MulFacilState extends State<MulFacil> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text('MULTIPLICAÇÃO - FÁCIL'),
        centerTitle: true,
      ),
      body: SafeArea(
        child: Column(
